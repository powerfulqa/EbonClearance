...
| 4 | Extract `EbonClearance_Protection.lua` (PE affix + chance-on-hit + Anvil-bridge cluster; bind-type cache stays in EbonClearance.lua for later) | **DONE** (commit `<pending>`) |
