...
| 8e-vii | Future: extract `EbonClearance_ProfilesImportExport.lua` (Profiles + ImportExport panels bundled; ~950 LOC). Depends on the profile-management helpers + the `runImport` / `runExport` plumbing | pending |
