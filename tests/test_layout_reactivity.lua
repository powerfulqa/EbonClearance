...
-- hand-written array - the array had silently drifted NINE files behind
-- the .toc. Locale files are excluded as before (no layout code). Same
-- derivation as tests/test_locale_coverage.lua.
local SOURCE_PATHS = {}
do
